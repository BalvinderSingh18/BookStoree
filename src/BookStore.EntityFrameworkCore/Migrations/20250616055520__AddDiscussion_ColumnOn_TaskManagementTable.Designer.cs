...
namespace BookStore.Migrations
{
    ...
    [Migration("20250616055520__AddDiscussion_ColumnOn_TaskManagementTable")]
    partial class _AddDiscussion_ColumnOn_TaskManagementTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Addmissions.Addmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("Admit_Date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BookStore.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BookStore.Beds.Bed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Cities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Countries.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Patients.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.States.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Students.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.TaskManagments.TaskManagment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BookStore.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BookStore.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BookStore.Addmissions.Addmission", b =>
                {
                    b.HasOne("BookStore.Beds.Bed", "Bed")
                        .WithMany()
                        .HasForeignKey("BedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.Patients.Patient", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("BookStore.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("BookStore.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Cities.City", b =>
                {
                    b.HasOne("BookStore.States.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.States.State", b =>
                {
                    b.HasOne("BookStore.Countries.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Students.Student", b =>
                {
                    b.HasOne("BookStore.Cities.City", "City")
                        .WithMany()
                    ...
                    b.HasOne("BookStore.Courses.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.TaskManagments.TaskManagment", b =>
                {
                    b.HasOne("BookStore.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
